...
public class ZipUtils {
	...
	public static void compress(String srcPath , String dstPath,OutputStream out) throws IOException{
	...
	private static void compress(File file, ZipOutputStream zipOut, String baseDir,OutputStream out) throws IOException{
		if (file.isDirectory()) {
