...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<Map> selUser(Map<String,Object> map) {
        return userDao.selUser(map);
    }

    @Override
    public List<Map> getAllTeacherInfo(Map<String, Object> map) {
        return userDao.getAllTeacherInfo(map);
    }
