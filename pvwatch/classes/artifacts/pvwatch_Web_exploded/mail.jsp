    ...
    <div class="mt-15" style="float:left;width: 15%;">
        <ul class="glvq" >
            ...
            <ol style="border-bottom: 1px solid rgb(204, 204, 204);margin-top:28px; ">
                <a onclick="conditions(10);" href="javascript:void(0);"><i><img alt="邮件服务器" src="static/img/email_new.png" style="width:16px;height:16px;margin-top:-4px"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未读</a>
            </ol>

            <ol style="border-bottom: 1px solid rgb(204, 204, 204);">
                <a onclick="conditions(20);" href="javascript:void(0);"  ><i><img alt="邮件服务器" src="static/img/email_read.png" style="width:16px;height:16px;margin-top:-4px"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已读</a>
            </ol>

            <ol style="border-bottom: 1px solid rgb(204, 204, 204);">
                <a onclick="conditions(30);"  href="javascript:void(0);"  ><i><img alt="邮件服务器" src="static/img/email_send.png" style="width:16px;height:16px;margin-top:-4px"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已录入</a>
            </ol>


            <ol style="border-bottom: 1px solid rgb(204, 204, 204);">
                <a onclick="conditions(2);" href="javascript:void(0);" ><i><img alt="邮件服务器" src="static/img/email_delete1.png" style="width:16px;height:16px;margin-top:-4px"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回收站</a>

            </ol>

            <ol style="border-bottom: 1px solid rgb(204, 204, 204);">
                <!-- <button style="float:right" class="btn btn-primary" type="button" id="saveMailConfig">菜单</button>	 -->
                <a id="saveMailConfig"  href="javascript:void(0);" ><i><img alt="邮件服务器" src="static/img/8.png" style="width:16px;height:16px;margin-top:-4px"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邮箱账户</a>
            </ol>
