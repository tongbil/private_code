...
<body>	
	...
	<script type="text/javascript"src="static/akehu1/jquery/jquery-1.11.0.min.js" />
	<script src="static/akehu/jsPlugin/bootstrap.min.js" type="text/javascript"/>
		<script type="text/javascript" src="static/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="static/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript" src="static/ueditor/lang/zh-cn/zh-cn.js"></script>	
	<script type="text/javascript" src="static/akehu/js/jquery.combo.select.js"></script>			
