...
//map point href
function Hui_admin_tabMap(href,title){
	if(href){
		var bStop=false;
		var bStopIndex=0;
		var _href=href;
...
$(function(){
	...
	//$.Huifold(".menu_dropdown dl dd ul .dropMenu",".menu_dropdown dl dd ul .dropMenu ul","fast",1,"click");
	/*选项卡导航*/
